# -*- coding: utf-8 -*-
{
    ...
    'data': [
        ...
        'data/data_system_type.xml',
        'data/data_boundary_condition_type.xml',
        'data/data_discretization_method.xml',
        'data/data_element_type.xml',
        'data/data_operator_type.xml',
        'data/data_sampling_axis.xml',
        'data/data_noise_type.xml',
        'data/data_aggregation_type.xml',
        'data/data_event_type.xml',
        'data/data_standard_graph_type.xml',
        'data/data_requirement_role.xml',
        'data/data_environment_type.xml',
        'data/data_dimension_type.xml',
        'data/data_reduction_type.xml',
        'data/data_continuation_algorithm.xml',
        'data/data_numerical_discretization_method.xml',
        'data/data_initial_state_method.xml',
        'data/data_sparse_format.xml',
        'data/data_specimen_enum.xml',
        'data/data_hemisphere.xml',
