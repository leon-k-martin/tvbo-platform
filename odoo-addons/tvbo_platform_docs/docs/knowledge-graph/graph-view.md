...
The graph view shows the same results as the list, drawn as a node-link diagram.
Nodes are entities; edges are the relationships between them, such as a model
